...
@interface TXTransRecordIntoController ()<UITableViewDelegate, UITableViewDataSource,NetErrorViewDelegate>
...
@implementation TXTransRecordIntoController
...
- (void)zj_viewWillAppearForIndex:(NSInteger)index {
    ...
    NSLog(@"zj_viewWillAppearForIndex-%ld", (long)index);
