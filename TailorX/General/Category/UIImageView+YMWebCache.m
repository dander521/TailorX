...
- (void)setCircleimageViewWithURL:(NSString *)imageUrl placeholderImage:(NSString *)placeholderImage {
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:placeholder completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL) {
