...
- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder completed:(EMSDWebImageCompletionBlock)completedBlock {
    [self sd_setImageWithURL:[self aliyunUrlWithUrl:url] placeholderImage:placeholder options:0 progress:nil completed:completedBlock];
}
...
- (void)sd_small_setImageWithURL:(nullable NSURL *)url
    ...
    [self sd_setImageWithURL:[self aliyunUrlWithUrl:url] placeholderImage:placeholder options:0 progress:nil completed:nil];
}
...
- (void)sd_small_setImageWithURL:(nullable NSURL *)url
    ...
    [self sd_setImageWithURL:[self aliyunUrlWithUrl:url] placeholderImage:placeholder options:options progress:nil completed:nil];
}

- (void)sd_small_setImageWithURL:(nullable NSURL *)url placeholderImage:(nullable UIImage *)placeholder completed:(nullable EMSDWebImageCompletionBlock)completedBlock {
