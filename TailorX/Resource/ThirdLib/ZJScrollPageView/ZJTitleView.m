...
- (void)layoutSubviews {
    ...
    self.badgeLabel.frame = CGRectMake(self.bounds.size.width - 28, CGRectGetMinY(self.bounds)+8, 15, 15);
}
...
- (void)setBadgeNum:(NSInteger)badgeNum {
    ...
    self.badgeLabel.hidden = badgeNum == 0 ? true : false;
    self.badgeLabel.backgroundColor = badgeNum == 0 ? [UIColor clearColor] : [UIColor redColor];
    
    self.badgeLabel.text = [NSString stringWithFormat:@"%zd", badgeNum];
}
